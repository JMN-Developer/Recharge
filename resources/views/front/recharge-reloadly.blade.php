                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="amount_input_field">
                                    ...
                                    <input type="text" id="amount" class="form-control " name="number" placeholder="Amount" style="width: 84%;"  autocomplete="off"  onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
