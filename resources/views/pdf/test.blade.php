        ...
        <table class="table table-bordered">
            {{-- <thead>
                <tr>
                    ...
                    @endif
                    <th scope="col" class="text-center border-0">test</th>
            ...
            <tbody>
                ...
                <tr>
                    <td> <span style="font-weight: bold">First Name </span> : {{$invoice->first}}</td>
                    <td> <span style="font-weight: bold"> Last Name </span> : {{$invoice->last}}</td>
                </tr>
                <tr>
                    <td> <span style="font-weight: bold"> Gender </span> : {{$invoice->gender}}</td>
                    <td> <span style="font-weight: bold"> Date Of Birth </span> : {{$invoice->dob}}</td>
                </tr>
                <tr>
                    <td> <span style="font-weight: bold"> Codice </span> : {{$invoice->codice}}</td>
                    <td> <span style="font-weight: bold"> ICCID Number </span> : {{$invoice->iccid}}</td>
                </tr>
                ...
                <tr>
                    <td> <span style="font-weight: bold"> Nazionalità </span> : {{$invoice->nationality}}</td>
