...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getEmailActionLink($type, $email, $actionCodeSettings = null, $locale = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->getEmailActionLink($type, $email, $actionCodeSettings, $locale);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getEmailVerificationLink($email, $actionCodeSettings = null, $locale = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->getEmailVerificationLink($email, $actionCodeSettings, $locale);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getPasswordResetLink($email, $actionCodeSettings = null, $locale = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->getPasswordResetLink($email, $actionCodeSettings, $locale);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getSignInWithEmailLink($email, $actionCodeSettings = null, $locale = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->getSignInWithEmailLink($email, $actionCodeSettings, $locale);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function signInWithAppleIdToken($idToken, $rawNonce = null, $redirectUrl = null, $linkingIdToken = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->signInWithAppleIdToken($idToken, $rawNonce, $redirectUrl, $linkingIdToken);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function signInWithIdpAccessToken($provider, $accessToken, $redirectUrl = null, $oauthTokenSecret = null, $linkingIdToken = null, $rawNonce = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->signInWithIdpAccessToken($provider, $accessToken, $redirectUrl, $oauthTokenSecret, $linkingIdToken, $rawNonce);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function signInWithIdpIdToken($provider, $idToken, $redirectUrl = null, $linkingIdToken = null, $rawNonce = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->signInWithIdpIdToken($provider, $idToken, $redirectUrl, $linkingIdToken, $rawNonce);
        }
                    /**
         * 
         *
