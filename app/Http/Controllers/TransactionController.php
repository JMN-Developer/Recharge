    ...
    public function index(Request $request)
    {
        if ($request->type=='datatable') {
            ...
            if(Auth::user()->role == 'admin')
            {
                ...
                {
                $data = TransactionHistory::whereBetween('created_at', [$start_date, $end_date])->latest()->get(['*']);
                ...
                else
                {
                    ...
                    $data = TransactionHistory:: where('reseller_id',$user_id)-> whereBetween('created_at', [$start_date, $end_date])->latest()->get(['*']);
